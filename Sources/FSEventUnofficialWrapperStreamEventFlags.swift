//
//  FSEventUnofficialWrapperStreamEventFlags.swift
...
/// Flags that can be passed to your `FSEventUnofficialWrapperStream`'s handler function.
/*
 ...
 */
public struct FSEventUnofficialWrapperStreamEventFlags: OptionSet {
    public let rawValue: FSEventStreamEventFlags
    public init(rawValue: FSEventStreamEventFlags) {
        self.rawValue = rawValue
    }
    fileprivate init(rawValue: Int) {
        self.rawValue = FSEventStreamEventFlags(truncatingBitPattern: rawValue)
    }
}

public extension FSEventUnofficialWrapperStreamEventFlags {
...
extension FSEventUnofficialWrapperStreamEventFlags: Hashable {
    public var hashValue: Int {
        return rawValue.hashValue
    }
}
extension FSEventUnofficialWrapperStreamEventFlags: CustomStringConvertible, CustomDebugStringConvertible {
//    private static func getAllFlags() -> [FSEventUnofficialWrapperStreamEventFlags] {
//        return [
////            .none,
//            .mustScanSubDirs,
//            .userDropped,
...
//            .none: ".none",
    ...
    public var debugDescription: String {
        let ns = FSEventUnofficialWrapperStreamEventFlags.getNameMapping()
